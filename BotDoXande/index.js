...
const { xandemenu } = require('./src/xandemenu')
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=5566996217678:+55 (66) 99621-7678\n' // ID do WhatsApp + número de telefone
            + 'END:VCARD'
/******END OF VCARD INPUT******/
		...
		try {
			...
			mess = {
				...
				only: {
					...
					ownerB: '[❗] Este comando só pode ser usado pelo Xande! ❌',
			...
			const ownerNumber = ["5566996217678@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '5566996217678@s.whatsapp.net'
                        /******ApiKey Input******/
