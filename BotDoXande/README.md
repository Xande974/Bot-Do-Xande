...
> pkg install nodejs
> pkg install npm
> git clone https://github.com/Xande974/Bot-Do-Xande.git
> cd Bot-Do-Xande
> bash install.sh
```
...
BotDoXande  | características únicas | sim
| :---------------------------------------------: | :-----------: |
...
NINGUÉM,O XANDE QUE FEZ SOZINHO KKKKKKK